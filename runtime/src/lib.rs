//! The Substrate Node Demo runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("example"),
	impl_name: create_runtime_str!("example"),
	authoring_version: 3,
	spec_version: 3,
	impl_version: 0,
